...
area2catena <- function(
  ...
  tryCatch({
    ...
    {  
      ...
      # convert (at) symbol to point (in case input comes from another GRASS mapset; readRAST() converts it to point implicitly which causes errors during later processing)
